            ...
            return (
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{
                    fontSize: "0.75rem", fontFamily: "var(--font-mono)", color: "var(--text-3)",
                    marginBottom: "0.2rem",
                  }}>
                  ...
                  <div style={{
                    ...
                    {c.title.replace(/OSINT Mission #\d+:\s*/, "")}
                  </div>
                  <div style={{ display: "flex", gap: "0.5rem", marginTop: "0.375rem", alignItems: "center" }}>
                    <span style={{ fontSize: "0.65rem", color: "var(--text-3)" }}>{c.category}</span>
            ...
            >
              ...
              <div style={{ marginBottom: "1.75rem" }}>
                ...
                <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "1rem" }}>
                  <h2 className="heading-lg">{selected.title.replace(/OSINT Mission #\d+:\s*/, "")}</h2>
